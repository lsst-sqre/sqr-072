...
.. code-block:: python
   ...
   def from_file(cls, path: str) -> Self:
       ...
       return cls.parse_obj(raw_configuration)
...
However, if you also need to use the nested ``Config`` class to configure Pydantic, you may need to change the name of your configuration class to ``Configuration`` to avoid naming conflicts with the nested class in the typing of the ``from_file`` function.
